...
export default function SingleProductPage() {
    return (
        <>
            <Hero img={singleProductImg} title='single prosuct'/>
            <ProductConsumer>
                {value =>{
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-10 mx-auto col-sm-8 col-md-6 my-3">
                                    ...
                                    <h5 className="text-capitalize tezt-muted mb-4">company : {company}</h5>
                <h5 className="text-main text-capitalize mb-4">price: ${price}</h5>
                <p className="text-capitalize tezt-title mt-3">some info about product :</p>
                <p>{description}</p>
